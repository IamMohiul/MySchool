            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.Teacher.update', $Teacher->id) }}"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                              <input type="text" name="profession" class="form-control" value="{{ $Teacher->profession }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="date" name="joindate" class="form-control" value="{{ $Teacher->joindate }}">
                        </div>
                    </div>
                    ...
                    @if ($Teacher->image)
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <img class="w-25" src="{{ asset($Teacher->image) }}" alt="">
                        </div>
                      </div>
                    @endif
