...
<section class="section">
  <div class="section-header">
    ...
    <h1>পাঠদানের অনুমতি ও স্বীকৃতি</h1>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
              ...
              <form action="{{ route('admin.Teaching.update',1) }}"  method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <textarea type="text" name="content" id="" class="summernote" style="">{{ $Teaching->content }}</textarea>
                    </div>
                  </div>
                  <div class="form-group row mb-4">
