      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
              ...
              <form action="{{ route('admin.Mpo.update',1) }}"  method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <textarea type="text" name="content" id="" class="summernote" style="">{{ $Mpo->content }}</textarea>
                    </div>
                  </div>
                  <div class="form-group row mb-4">
