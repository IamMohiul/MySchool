          ...
          <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.About_school.update',1) }}"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Meta Tag</label>
                      <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea type="text" name="content" id="" class="summernote" style=""></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
