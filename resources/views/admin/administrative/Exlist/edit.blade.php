        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.Exlist.update', $Exlist->id) }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <input type="text" name="name" class="form-control" value="{{ $Exlist->name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                              <input type="text" name="profession" class="form-control" value="{{ $Exlist->profession }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" name="mobile" class="form-control" value="{{ $Exlist->mobile }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="email" name="email" class="form-control" value="{{ $Exlist->email }}">
                        </div>
                    </div>
                    ...
                    @if ($Exlist->image)
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <img class="w-25" src="{{ asset($Exlist->image) }}" alt="">
                        </div>
                      </div>
                    @endif
