        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.Students.update', $Students->id) }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-sm-12 col-md-7">
                          <select class="form-control selectric" name="class_id" id="class">
                            ...
                            @foreach ($Classes as $class)
                                <option {{ $class->id == $Students->class_id ? 'selected':''}} value="{{ $class->id }}">{{ $class ->name }}</option>
                            @endforeach
                          </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="section" class="form-control" value="{{ $Students->section }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <input type="text" name="boy" class="form-control" value="{{ $Students->boy }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <input type="text" name="girl" class="form-control" value="{{ $Students->girl }}">
                        </div>
                    </div>
