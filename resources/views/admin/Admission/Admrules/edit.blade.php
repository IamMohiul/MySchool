        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.Admrules.update', $Admrules->id) }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <input type="text" name="title" class="form-control" value="{{ $Admrules->title }}">
                        </div>
                    </div>
